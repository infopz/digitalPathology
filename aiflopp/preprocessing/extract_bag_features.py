...
if __name__ == "__main__":
    ...
    PATCH_FOLDER_PATH = Path("/home/ubuntu/giodir/digitalPathology/data/alice/bag/")
    OUTPUT_PATH = Path("/home/ubuntu/giodir/digitalPathology/data/uni_features_RE_common/")
